...
if __name__ == '__main__':
    ...
    test_dict2 = load_dict_from_hdf5('/Users/faridyagubbayli/Work/fieldII_converging_wave_mlt_sector.uff')
    ...
    uff1 = traverse(test_dict)
    uff2 = traverse(test_dict2)
    print(uff1.channel_data == uff2.channel_data)
